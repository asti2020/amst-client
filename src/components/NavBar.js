...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <a href="https://flowbite.com/" class="flex items-center">
      <img src="https://imgv3.fotor.com/images/blog-cover-image/part-blurry-image.jpg" class="h-8 mr-3" alt="Flowbite Logo" />
  ...
  <div class="flex items-center md:order-2">
      ...
      <div type="button" class="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
        ...
        <img className="w-8 h-8 rounded-full" src="https://imgv3.fotor.com/images/blog-cover-image/part-blurry-image.jpg" alt="user photo"> </img>
      </div>
      ...
      <div data-collapse-toggle="mobile-menu-2" type="button" class="inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
